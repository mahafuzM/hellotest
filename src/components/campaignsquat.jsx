...
import { 
  ...
  Earth,        // International Client Served
  MapPin,       // Local Client Served
  Palette,      // Product Design
  Smartphone    // App Development
} from 'lucide-react';
import aboutBanner from '../assets/images/h2-about-banner.webp';

// Counter Component to make numbers "run"
...
const CampaignSquat = () => {
  // Icons set to w-14 h-14 for larger appearance
  const stats = [
    { value: "250", label: "Website Development", icon: <Globe className="w-14 h-14 text-white hover:text-[#f7a400" strokeWidth={1.5} /> },
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-16 lg:px-24 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center mb-24">
          ...
          <div className="relative group order-2 lg:order-1">
            <div className="relative z-10 rounded-[5px] overflow-hidden border border-white/10 aspect-[4/5] md:aspect-auto">
              <img 
                src={aboutBanner} 
                alt="About Us" 
           ...
           {/* Experience Floating Card */}
<div className="absolute bottom-6 left-4 md:bottom-12 md:-left-2 z-20 bg-white/5 backdrop-blur-xl border border-white/20 p-5 md:p-8 rounded-[5px] shadow-[0_20px_50px_rgba(0,0,0,0.5)] animate-float">
  <div className="flex items-center gap-4">
    ...
    <div className="text-white text-[11px] md:text-[15px] font-semibold leading-tight">
      Years of <br /> Industry <br /> Mastery
            ...
            <div className="absolute -top-10 -right-10 w-32 h-32 opacity-20 bg-[radial-gradient(#F7A400_2px,transparent_2px)] [background-size:16px_16px]"></div>
          </div>
          ...
          <div className="flex flex-col space-y-8 order-1 lg:order-2">
            ...
            <h2 className="text-white text-[26px] md:text-[32px] lg:text-[40px] font-semibold leading-[1.2] md:leading-[1.3] tracking-tight ">
              We Don’t Just Code, <br />
              <span>We Engineer Growth.</span>
            </h2>
                ...
                <button className="group relative px-8 py-2 bg-[#F7A400] border-2 border-[#F7A400] rounded-[5px] font-semibold text-black transition-all duration-300 hover:text-white hover:bg-[#02050A] active:scale-95 text-[12px] md:text-[15px]">
                  <span className="relative z-10 flex items-center gap-2">
                    ...
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="transition-all duration-300 group-hover:translate-x-2">
                      <path d="M5 12h14" className="opacity-0 group-hover:opacity-100 transition-all duration-300" />
        ...
        {/* --- Stats Grid Section --- */}
       {/* --- Stats Grid Section --- */}
      <div className="border-t border-white/10 pt-16 mt-10">
  <div className="max-w-[1440px] mx-auto px-4 md:px-16 lg:px-22">
    {/* Grid setup: Mobile-e 2 column, Tablet-e 2, Desktop-e 3 */}
    <div className="grid grid-cols-2 lg:grid-cols-3 gap-x-3 gap-y-12 md:gap-x-12 lg:gap-x-20">
      {stats.map((stat, index) => (
        ...
        >
          {/* Icon Container: Size ektu boro kintu mobile-friendly */}
          ...
          {/* Text Content: Mobile-e text center, Tablet theke left align */}
